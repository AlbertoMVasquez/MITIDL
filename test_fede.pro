...
;           v1.1, Fede: pruebo las modificaciones que hice 
;---------------------------------------------------------------------
...
; goto,ef
  ...
  print,g_function_fede(Te0, Ne0)
  print
  print,'s [erg(/PH) cm-3 sec-1 sr-1]:'
  print,s_function_fede(Ne0, Te0)
  print
  print,'p [cm+3 K-1]:'
  print,p_function_fede(Ne0, Te0)
  print
  print,'s*p [erg(/PH) sec-1 sr-1 K-1]:'
  print,sp_function_fede(Ne0, Te0)
  print
  ...
  print, e_function_fede(parameters)
  print

  print,'e2[erg sec-1 sr-1 K-1]:'
  print, e2_function_fede(parameters)
  print
  ...
  print, 'cost_function:'
  print, cost_function_fede(parameters)
