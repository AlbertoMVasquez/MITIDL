  ...
  pro plot_scatter_and_historatio,x,y,$
                                  dir=dir,filename=filename,xsuffix=xsuffix,$
                                  ysuffix=ysuffix,titulo=titulo,$
    ...
    ; los rangos de los scatter plots
   ...
   xyouts,0.5+fltarr(nstat),.4-.05*findgen(nstat),['Mean =','Stdev =']+$
          ...
          color=100+fltarr(nstat),/normal;,charthick=6
   loadct,0
   ;ps2
   record_jpg,dir,filename+'.jpg'
   !p.multi=0
